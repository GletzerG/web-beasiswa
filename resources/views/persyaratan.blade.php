...
@section('content')
    <div class="container py-5">
        <h1 class="text-center">Persyaratan Pendaftaran Beasiswa</h1>
        <p>Ketentuan Persyaratan Umum:
        <ul>
            ...
            <li>Tidak sedang dalam proses hukum atau terlibat pelanggaran hukum lainnya, dibuktikan dengan surat pernyataan bermaterai.</li>
